...
function getCardId(value) {
    var first = value.slice(0,-1), last = value[value.length-1], row,position;
    switch(last){
    	case "♣":row=1;break;
    	case "♦":row=2;break;
    	case "♥":row=3;break;
    ...
    switch(first){
    	...
    	case "Q":position=11;break;
    	case "K":position=12;break;
    	default: position=Number(first)-1;break;
    }
    return 13*row-13+position;
}
